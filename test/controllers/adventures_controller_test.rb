...
class AdventuresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adventure" do
    assert_difference('Adventure.count') do
      post adventures_url, params: { adventure: { capital: @adventure.capital, name: @adventure.name, population: @adventure.population } }
    end
  ...
  test "should update adventure" do
    patch adventure_url(@adventure), params: { adventure: { capital: @adventure.capital, name: @adventure.name, population: @adventure.population } }
